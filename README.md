...
* Рефакторинг и **ускорение кода**  за счет оптимизации алгоритмов, кеширования, векторизации, jit-компиляции, сборки мусора, параллеллизма и т. д., устранение утечек памяти и работа с горячими точками (большой опыт на C# и Python, есть опыт на C++, D)
...
* Занимаюсь пауэрлифтингом и фитнесом с 12 лет, делаю выход на две 10 раз подряд на изи, единственный на районе умею выход со скрещенными руками
* На базовом уровне знаю немецкий и персидский
* Пишу классные произведения, но их никто не читает
* Пою глубокий реп, но получается убого
