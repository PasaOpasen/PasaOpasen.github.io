...
* Рефакторинг и **ускорение кода** (большой опыт на C# / Python / R, есть опыт на C++, D) за счет 
  ...
  * реализации на более низкоуровневых язывках (или Cython в случае с Python). 
...
* знаком с JavaScript, TypeScript, middle C++, небольшой опыт с Java, D
...
* уверенное владение Linux (без системного администрирования) 
...
* Слабости: красивые девки и сладкое, но им я не поддаюсь
