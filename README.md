...
* **senior C#** (работал с C# 7 и ранними версиями с начала 2017-го по 2020й, знаю ООП, ФП, LINQ, дженерики, коллекции, события, асинхронность, параллелизм, контракты, сборку мусора, MathNet Numerics, NUnit, богатый опыт работы с WinForms, есть опыт WPF, хорошо знаю .NET Framework), знаком с F#, функциональное программирование щёлкаю на раз-два
...
* На базовом уровне знаю немецкий и фарси, интересуюсь культурой Ближнего Востока
...
* Слабости: красивые девки и сладкое
