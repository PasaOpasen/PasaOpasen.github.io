...
* **Оптимизационные алгоритмы**
  * *Реализация/разработка мат. алгоритмов* для решения конкретных задач; как правило, это **эволюционные алгоритмы** и разные методы оптимизации, включая динамическое программирование. Также есть большой опыт в Computer Vision.
