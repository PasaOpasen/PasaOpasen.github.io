...
* **Оптимизационные алгоритмы**
  * *Реализация/разработка мат. алгоритмов* для решения конкретных задач; как правило, это **эволюционные алгоритмы** и разные методы оптимизации, включая динамическое программирование
  * Большой опыт в Computer Vision
  * Большой опыт с алгоритмами для объектов на плоскости
...
* Развёртываение, контейнеризация
  ...
  * Умеренный опыт с GitHub Actions
  * Умеренный опыт с Jenkins
  * Умеренный опыт с Ansible
...
* уверенное владение Linux, bash, Docker 
