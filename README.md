...
* ***Оптимизационные алгоритмы***
  * *Реализация/разработка мат. алгоритмов* для решения конкретных задач; как правило, это **эволюционные алгоритмы** и разные методы оптимизации, включая динамическое программирование; хорошо оптимизирую (ускоряю) математические алгоритмы
...
* окончил *"Факультет математики и компьютерных наук"* (КубГУ) в 2019м году с красным дипломом (бакалавр) и с красным в 2021м (магистр)
