...
* ***Развёртывание, контейнеризация, автоматизация***. Предпочитаю все оборачивать в `bash`, затем в `make`, затем в `ansible`.
  * Богатый опыт с **Docker**, **Compose**
  * Очень хорошее знание **Linux**, **Bash**, очень большой опыт с RedHat системами, есть опыт с Astra Linux
...
* **senior Python** (очень активно использую Python3.8 с начала 2020-го, хорошо знаю стандратную библиотеку, numpy, pandas, matplotlib, sklearn, gensim, sympy, numba), владею Jupyter, Cython; с Django и Flask более чем знаком, но почти не занимаюсь бекэндом
...
* спортсмен с большим стажем, до сих пор тренируюсь около 10 часов в неделю
...
* достаточно часто читаю книги O'Reilly, Packt, Apress
