...
**Научный программист *(специалист по Data Science, Machine Learning, математике, оптимизации кода)***
...
* **Оптимизационные алгоритмы**. *Реализация/разработка мат. алгоритмов* для решения конкретных задач; как правило, это **эволюционные алгоритмы** и разные методы оптимизации, включая динамическое программирование. Также есть опыт в Computer Vision.
...
* c июля 2021-го являюсь python engineer в [AprBot](http://aprbot.com/)
